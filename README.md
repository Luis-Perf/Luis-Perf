...
### 🧰 O que eu faço:
- ⚙️ **APIs REST** com **FastAPI + JWT**, prontas para produção  
- 🗄️ **SQLAlchemy + Alembic (PostgreSQL)** — dados seguros e versionados  
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,fastapi,postgres,java,maven,selenium,js,ts,vue,html,css,react&theme=dark" />
</p>
